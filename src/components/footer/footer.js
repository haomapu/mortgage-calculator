...
const Footer = () => {
  return (
    <div className="container text-black grid pt-40 footer">
      <div className="footer-left flex flex-col">
        <div className="flex space-x-5 mb-6">
          ...
          <p
            className="font-bold text-2xl self-center leading-8"
            style={{ color: "#40434A" }}
          >
            Kinka <br></br> Finance
          </p>
        ...
        <p
          className="text-xl leading-9 mb-10"
          style={{ color: "#585C65", maxWidth: "371px" }}
        >
      ...
      <div className="grid grid-cols-3 grid-rows-5 gap-x-4 footer-right">
        <div className="cols-span-1 space-y-8">
          <h1 className="text-xl font-bold" style={{ color: "#40434A" }}>
            Location
          </h1>
          <div className="space-y-6">
            <p className="leading-8" style={{ color: "#70737C" }}>
              America
            </p>
            <p className="leading-8" style={{ color: "#70737C" }}>
              Asia
